# This script compares two fasta files: the dataset "sample.fasta" and file
...
# Этот блок переписывает изучаемые последовательности в одну линию
with open('sample.fasta') as inf:
